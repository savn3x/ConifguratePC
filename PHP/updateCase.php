...
<body>
    ...
    <form action="testCase.php" method="POST">
        <div class="form-group">
            <label for="">Id</label>
            <input type="text" name="id_obudowa" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="">max dlugosc karty</label>
            <input type="text" name="maks_dlugosc_karty_graf" class="form-control">
        </div>
        <div class="form-group">
            <label for="">typ obudowy</label>
            <input type="text" name="typ_obudowy" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <button type="submit" name="updateCase"> Update Data </button>
        </div>
    </form>
